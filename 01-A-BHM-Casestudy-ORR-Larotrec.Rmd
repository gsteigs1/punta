...
Note: inconsistency in ERG report page 66: "The prior distribution for p was centred around a probability of 0.3 (a log-odds of -1.3863)".
-> logit(0.3) = -0.847
...
# Analysis with reduced data set (ERG prior)
